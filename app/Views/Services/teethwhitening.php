...
<div class="jumbotron jumbotron-fluid" style="margin-bottom: 90px; background-color:#7E564E;">
  <div class="container text-center py-5">
    ...
    <div class="d-inline-flex align-items-center text-white">
      ...
      <p class="m-0"><a class="text-white" href="<?php echo base_url();?>/services">Services</a></p>
      <i class="far fa-circle px-3"></i>
      <p class="m-0"><a class="text-white" href="">Teeth Whitening</a></p>
    </div>
  </div>
</div>
<!-- Header End -->
...
<!-- Service Info Start -->
<?php if($services): foreach($services as $vice): if($vice['view'] == 'teethwhitening'):?>
